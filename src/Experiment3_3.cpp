...
// TIPS: 测方差，只测flickr, k=3, theta=0.8
// 1520
//
...
int main(void)
{
    ...
    for(int i = 1; i < 2; i++){ // TIPS: 只测flickr
        string file = files[i];
        ...
        for(int l = 0; l < 1; l++) { //
            ...
            vector<double> vars_mcs, vars_ss_vl, vars_ss_sc, vars_ls,
                    vars_lssa_vl, vars_lssa_sc;
            ...
            for (int ll = 0; ll < qn; ll++) {
                ...
                for (int lll = 0; lll < n0; lll++) {
                    printf("%s:  1/1 k, %d/%d q, %d/%d loop, mcs\n",
                           file.c_str(),
                           ll + 1, qn,
                           lll + 1, n0);
                    ...
                    START
                    mcs_with_prune(G_prune_i, Edges_prune_i, C, q, k, theta, Pr_v, 1000);
                    END("MCS")
                ...
                Prs.clear();
                for (int lll = 0; lll < n0; lll++) {
                    printf("%s:  1/1 k, %d/%d q, %d/%d loop, ss-vl\n",
                           file.c_str(),
                           ll + 1, (int) qn,
                           lll + 1, n0);
                    ...
                    START
                    ss_vl(G_prune_i, Edges_prune_i, C, q, k, theta, Pr_v, 1000);
                    END("SS-VL")
                ...
                Pr_v_avg.clear();
                for (int lll = 0; lll < n0; lll++) {
                    printf("%s:  1/1 k, %d/%d q, %d/%d loop, ss-sc\n",
                           file.c_str(),
                           ll + 1, qn,
                           lll + 1, n0);
                    ...
                    START
                    ss_sc(G_prune_i, Edges_prune_i, dG_prune_i, C, q, k, theta, Pr_v, 1000);
                    END("SS-SC")
                ...
                Prs.clear();
                for (int lll = 0; lll < n0; lll++) {
                    printf("%s:  1/1 k, %d/%d q, %d/%d loop, ls\n",
                           file.c_str(),
                           ll + 1, qn,
                           lll + 1, n0);
                    ...
                    START
                    ls(G_prune_i, Edges_prune_i, C, q, k, theta, Pr_v, 1000);
                    END("LS")
                ...
                Prs.clear();
                for (int lll = 0; lll < n0; lll++) {
                    printf("%s:  1/1 k, %d/%d q, %d/%d loop, lssa-vl\n",
                           file.c_str(),
                           ll + 1, qn,
                           lll + 1, n0);
                    ...
                    START
                    lssa_vl(G_prune_i, Edges_prune_i, C, q, k, theta, Pr_v, 1000);
                    END("LSSA-VL")
                ...
                Prs.clear();
                for (int lll = 0; lll < n0; lll++) {
                    printf("%s:  1/1 k, %d/%d q, %d/%d loop, lssa-sc\n",
                           file.c_str(),
                           ll + 1, qn,
                           lll + 1, n0);
                    ...
                    START
                    lssa_sc(G_prune_i, Edges_prune_i, dG_prune_i, C, q, k, theta, Pr_v, 1000);
                    END("LSSA-SC")
