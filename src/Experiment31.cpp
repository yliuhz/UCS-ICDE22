...
//    vector<int> Ns = {250, 500, 750, 1000, 1250, 1500};
    ...
    vector<int> rs = {10,30,50,70,90,110};
    ...
    for(int i = 0; i < 1; i++){ // TIPS: 从email开始
        ...
        for(int l = 1; l < 2; l++) { //
            ...
            unordered_map<int,vector<double>> r2time_ss_sc, r2time_lssa_sc;
            ...
            for (int ll = 0; ll < qn; ll++) {
                ...
                for(int j = 0; j < rs.size(); j++){
                    ...
                    for (int lll = 0; lll < n0; lll++) {
                        ...
                        start = clock();
                        ss_sc_r(G_prune_i, Edges_prune_i, C, q, k, theta, Pr_v, r);
                        end = clock();
                    ...
                    for (int lll = 0; lll < n0; lll++) {
                        ...
                        start = clock();
                        lssa_sc_r(G_prune_i, Edges_prune_i, C, q, k, theta, Pr_v, r);
                        end = clock();
                        time = (double) (end - start) / CLOCKS_PER_SEC;
            ...
            for(auto [r, time_of_qs] : r2time_ss_sc){
                ...
                for (int j = 0; j < qn; j++) {
                    if (j % 10 == 0) out << endl;
                    out << time_of_qs[j] << " ";
                    avgtime += time_of_qs[j];
                }
                out << endl;
                out<<"avgtime: "<<avgtime/20.0<<endl;
            }
            out.close();
