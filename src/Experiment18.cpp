...
//    vector<int> Ns = {500, 1000, 1500, 2000};
    ...
    for(int i = 0; i < 1; i++){ // TIPS: 从email开始
        ...
        for(int l = 0; l < 1; l++) { //
            ...
            unordered_map<double,vector<double>> k02time_ss_vl, k02time_lssa_vl;
            ...
            for (int ll = 0; ll < qn; ll++) {
                ...
                for(int j = 0; j < k0s.size(); j++){
                    ...
                    for (int lll = 0; lll < n0; lll++) {
                        ...
                        k02time_ss_vl[k0].emplace_back(time);
                    }
                    ...
                    for (int lll = 0; lll < n0; lll++) {
                        ...
                        k02time_lssa_vl[k0].emplace_back(time);
                    }
                }
            }
            ...
            out << "k=" << k << endl;
            for(auto [k0, time_of_qs] : k02time_ss_vl){
                out<<"k0="<<k0;
                for (int j = 0; j < qn; j++) {
                    if (j % 10 == 0) out << endl;
                    out << time_of_qs[j] << " ";
            ...
            out << "k=" << k << endl;
            for(auto [k0, time_of_qs] : k02time_lssa_vl){
                out<<"k0="<<k0;
                for (int j = 0; j < qn; j++) {
                    if (j % 10 == 0) out << endl;
                    out << time_of_qs[j] << " ";
