...
// TIPS: 测方差，只测email, k=3, \theta=0.8, r变化
// 1520
//
...
//    vector<int> Ns = {500, 1000, 1500, 2000};
    ...
    for(int i = 0; i < 1; i++){ // TIPS: 从email开始
        ...
        for(int l = 0; l < 1; l++) { //
            ...
            unordered_map<int,vector<double>> r2vars_ss_vl, r2vars_ss_sc,
                    r2vars_lssa_vl, r2vars_lssa_sc;
            ...
            for (int ll = 0; ll < qn; ll++) {
                ...
                for(int j = 0; j < rs.size(); j++){
                    ...
                    r2vars_ss_vl[r].emplace_back(var);
                    ...
                    r2vars_ss_sc[r].emplace_back(var);
                    ...
                    r2vars_lssa_vl[r].emplace_back(var);
                    ...
                    r2vars_lssa_sc[r].emplace_back(var);
            ...
            for(auto [r, vars_of_qs] : r2vars_ss_vl){
                var_avg = 0.0;
                out<<"r="<<r;
                for (int j = 0; j < qn; j++) {
                    if (j % 10 == 0) out << endl;
            ...
            for(auto [r, vars_of_qs] : r2vars_ss_sc){
                var_avg = 0.0;
                out<<"r="<<r;
                for (int j = 0; j < qn; j++) {
                    if (j % 10 == 0) out << endl;
            ...
            for(auto [r, vars_of_qs] : r2vars_lssa_vl){
                var_avg = 0.0;
                out<<"r="<<r;
                for (int j = 0; j < qn; j++) {
                    if (j % 10 == 0) out << endl;
            ...
            for(auto [r, vars_of_qs] : r2vars_lssa_sc){
                var_avg = 0.0;
                out<<"r="<<r;
                for (int j = 0; j < qn; j++) {
                    if (j % 10 == 0) out << endl;
